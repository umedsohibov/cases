...
создать заметку
curl -X POST http://127.0.0.1:5001/notes -H "Content-Type: application/json" -d '{"title": "test ", "content": " test"}'

получить заметку по id
curl http://127.0.0.1:5001/notes/1

обновить заметку
curl -X PUT http://127.0.0.1:5001/notes/5 -H "Content-Type: application/json" -d '{"title": "Updated title", "content": "Updated content"}'
